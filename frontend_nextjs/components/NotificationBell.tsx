        ...
        {isOpen && (
          <>
            ...
            <motion.div 
              ...
              className="absolute right-0 mt-4 w-96 bg-white border border-slate-100 rounded-[2.5rem] shadow-2xl z-50 overflow-hidden"
            >
              <div className="p-6 border-b border-slate-50 flex items-center justify-between bg-slate-50/50">
                <h3 className="font-black text-slate-900 tracking-tight">AI Advisor Insights</h3>
                <button onClick={clearAlerts} className="text-[10px] font-black text-brand-600 uppercase tracking-widest hover:underline">
                  Clear All
                </button>
              </div>
